...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO musicos (nombre_completo, apellidos, nombre_artistico, correo_electronico, fecha_nacimiento, genero, contrasena, video, numero_telefono, ciudad_origen, foto_perfil)
            VALUES ('$nombre', '$apellidos', '$nombreartistico', '$correo', '$fecha_nacimiento', '$genero', '$contrasena', '$video', '$numero_telefono', '$ciudad_origen', 'defect.jpg')";
