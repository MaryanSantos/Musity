        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                   ...
                   <p>¿No tienes cuenta con nosotros? Entonces <a class="white" href="./multi/registroC.php">Registrate aquí si quieres contratar</a> o <a class="white" href="regmusico.php">Regístrate aquí si quieres ofrecer tus servicios</a> </p> 
                    <!-- Sign Up Form -->
                    <div class="form-container">
                        <form  action="control.php" data-toggle="validator" method="GET">
                            <div class="form-group">
                                <input type="email" name="correo" class="form-control-input" placeholder="Correo" required>
                                <label class="label-control" >Correo</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="password" name="contrasena" class="form-control-input" placeholder="contraseña" required>
