                   ...
                   <p>Completa el siguiente formulario para registrarte en Musity. ¿Ya estas registrado? Entonces solo <a class="white" href="log-in.php">Inicia sesión aquí</a></p> 
                    ...
                    <div class="form-container">
                        <form  data-toggle="validator" action="insertar_datosM.php" method="POST" >
                            ...
                            <div class="form-group">
                                <input type="password" name="contrasena" class="form-control-input" pattern="[A-Z]a-z_-0-9]{1,20}"  title="La contraseña debe tener al menos 8 caracteres, una mayúscula y un carácter especial" required oninput="mostrarMensajeError(this)">
                            ...
                            <div class="form-group">
                                <input type="file" name="video" class="form-control-input" accept="video/*" required>
                            ...
                            <div class="form-group">
                                <input type="file"  name="foto_perfil" class="form-control-input" accept="image/*" required>
